...
/**
 * @swagger
 * /collections/products/all/search:
 *   get:
 *     summary: Search all products with out login
 *     description: A user can search for products by name, category, and price range woth out login. The search can be a combination of these criteria with an AND operation.
 *     tags:
 *       - PRODUCT
 *     parameters:
 *       - in: query
